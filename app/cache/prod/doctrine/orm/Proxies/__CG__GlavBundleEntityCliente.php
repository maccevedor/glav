 ...
 */
class Cliente extends \GlavBundle\Entity\Cliente implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GlavBundle\\Entity\\Cliente' . "\0" . 'id', '' . "\0" . 'GlavBundle\\Entity\\Cliente' . "\0" . 'identificacion', '' . "\0" . 'GlavBundle\\Entity\\Cliente' . "\0" . 'nombre', '' . "\0" . 'GlavBundle\\Entity\\Cliente' . "\0" . 'apellido', '' . "\0" . 'GlavBundle\\Entity\\Cliente' . "\0" . 'genero', '' . "\0" . 'GlavBundle\\Entity\\Cliente' . "\0" . 'fNacimiento', '' . "\0" . 'GlavBundle\\Entity\\Cliente' . "\0" . 'direccion', '' . "\0" . 'GlavBundle\\Entity\\Cliente' . "\0" . 'telefono', '' . "\0" . 'GlavBundle\\Entity\\Cliente' . "\0" . 'celular', '' . "\0" . 'GlavBundle\\Entity\\Cliente' . "\0" . 'email', '' . "\0" . 'GlavBundle\\Entity\\Cliente' . "\0" . 'estado', '' . "\0" . 'GlavBundle\\Entity\\Cliente' . "\0" . 'fecha');
        }
