 ...
 */
class GrlCiudad extends \GlavBundle\Entity\GrlCiudad implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GlavBundle\\Entity\\GrlCiudad' . "\0" . 'id', '' . "\0" . 'GlavBundle\\Entity\\GrlCiudad' . "\0" . 'idGrlRegion', '' . "\0" . 'GlavBundle\\Entity\\GrlCiudad' . "\0" . 'codigo', '' . "\0" . 'GlavBundle\\Entity\\GrlCiudad' . "\0" . 'nombre', '' . "\0" . 'GlavBundle\\Entity\\GrlCiudad' . "\0" . 'latitud', '' . "\0" . 'GlavBundle\\Entity\\GrlCiudad' . "\0" . 'longitud', '' . "\0" . 'GlavBundle\\Entity\\GrlCiudad' . "\0" . 'estado');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GrlCiudad $proxy) {
    ...
    public function setIdGrlRegion($idGrlRegion)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdGrlRegion', array($idGrlRegion));

        return parent::setIdGrlRegion($idGrlRegion);
    }
    ...
    public function getIdGrlRegion()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdGrlRegion', array());

        return parent::getIdGrlRegion();
    }
