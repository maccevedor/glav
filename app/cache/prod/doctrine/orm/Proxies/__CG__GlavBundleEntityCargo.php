 ...
 */
class Cargo extends \GlavBundle\Entity\Cargo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GlavBundle\\Entity\\Cargo' . "\0" . 'id', '' . "\0" . 'GlavBundle\\Entity\\Cargo' . "\0" . 'hash', '' . "\0" . 'GlavBundle\\Entity\\Cargo' . "\0" . 'nombre', '' . "\0" . 'GlavBundle\\Entity\\Cargo' . "\0" . 'descripcion', '' . "\0" . 'GlavBundle\\Entity\\Cargo' . "\0" . 'estado', '' . "\0" . 'GlavBundle\\Entity\\Cargo' . "\0" . 'fecha');
        }
