 ...
 */
class ServicioEstado extends \GlavBundle\Entity\ServicioEstado implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GlavBundle\\Entity\\ServicioEstado' . "\0" . 'id', '' . "\0" . 'GlavBundle\\Entity\\ServicioEstado' . "\0" . 'hash', '' . "\0" . 'GlavBundle\\Entity\\ServicioEstado' . "\0" . 'nombre', '' . "\0" . 'GlavBundle\\Entity\\ServicioEstado' . "\0" . 'estado', '' . "\0" . 'GlavBundle\\Entity\\ServicioEstado' . "\0" . 'fecha');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ServicioEstado $proxy) {
