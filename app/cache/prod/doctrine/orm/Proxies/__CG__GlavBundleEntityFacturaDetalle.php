 ...
 */
class FacturaDetalle extends \GlavBundle\Entity\FacturaDetalle implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GlavBundle\\Entity\\FacturaDetalle' . "\0" . 'id', '' . "\0" . 'GlavBundle\\Entity\\FacturaDetalle' . "\0" . 'hash', '' . "\0" . 'GlavBundle\\Entity\\FacturaDetalle' . "\0" . 'id_factura', '' . "\0" . 'GlavBundle\\Entity\\FacturaDetalle' . "\0" . 'id_servicio', '' . "\0" . 'GlavBundle\\Entity\\FacturaDetalle' . "\0" . 'cantidad', '' . "\0" . 'GlavBundle\\Entity\\FacturaDetalle' . "\0" . 'valor', '' . "\0" . 'GlavBundle\\Entity\\FacturaDetalle' . "\0" . 'iva', '' . "\0" . 'GlavBundle\\Entity\\FacturaDetalle' . "\0" . 'total', '' . "\0" . 'GlavBundle\\Entity\\FacturaDetalle' . "\0" . 'estado', '' . "\0" . 'GlavBundle\\Entity\\FacturaDetalle' . "\0" . 'fecha');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FacturaDetalle $proxy) {
