...
/* GlavBundle:TipoRubro:show.html.twig */
class __TwigTemplate_94729907acbfdf46878527d8748ba14e6756486f40301a448c8b87613df347b1 extends Twig_Template
{
    ...
    <li>
        <a href=\"";
        // line 42
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("tiporubro_edit", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id", array()))), "html", null, true);
        echo "\">
            Edit
        </a>
    </li>
...
";
    ...
    {
        return "GlavBundle:TipoRubro:show.html.twig";
    }
