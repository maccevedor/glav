...
/* GlavBundle:TipoAutomotor:index.html.twig */
class __TwigTemplate_32509cf393af8f50fd302015820db83eb06ea4370a5afe3a6a548b7a1a2e5ce1 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("GlavBundle::layoutAdmin.html.twig", "GlavBundle:TipoAutomotor:index.html.twig", 1);
        $this->blocks = array(
    ...
    <table class=\"table table-striped>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            echo "            <tr>
                <td><a href=\"";
            // line 20
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("tipoautomotor_show", array("id" => $this->getAttribute($context["entity"], "id", array()))), "html", null, true);
            echo "\">";
            ...
            echo "\">show</a>
                    ...
                    <li>
                        <a href=\"";
            // line 31
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("tipoautomotor_edit", array("id" => $this->getAttribute($context["entity"], "id", array()))), "html", null, true);
            echo "\">edit</a>
                    </li>
                </ul>
                </td>
        ...
        <li>
            <a href=\"";
        // line 42
        echo $this->env->getExtension('routing')->getPath("tipoautomotor_new");
        echo "\">
                Create a new entry
            </a>
        </li>
    ...
    {
        return "GlavBundle:TipoAutomotor:index.html.twig";
    }
