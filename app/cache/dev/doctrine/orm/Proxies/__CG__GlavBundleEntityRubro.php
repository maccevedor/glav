 ...
 */
class Rubro extends \GlavBundle\Entity\Rubro implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GlavBundle\\Entity\\Rubro' . "\0" . 'id', '' . "\0" . 'GlavBundle\\Entity\\Rubro' . "\0" . 'hash', '' . "\0" . 'GlavBundle\\Entity\\Rubro' . "\0" . 'nombre', '' . "\0" . 'GlavBundle\\Entity\\Rubro' . "\0" . 'id_tipo_rubro', '' . "\0" . 'GlavBundle\\Entity\\Rubro' . "\0" . 'descripcion', '' . "\0" . 'GlavBundle\\Entity\\Rubro' . "\0" . 'valor', '' . "\0" . 'GlavBundle\\Entity\\Rubro' . "\0" . 'iva', '' . "\0" . 'GlavBundle\\Entity\\Rubro' . "\0" . 'estado', '' . "\0" . 'GlavBundle\\Entity\\Rubro' . "\0" . 'fecha');
        }
    ...
    public function setIdTipoRubro($idTipoRubro)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdTipoRubro', array($idTipoRubro));

        return parent::setIdTipoRubro($idTipoRubro);
    }
    ...
    public function getIdTipoRubro()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdTipoRubro', array());

        return parent::getIdTipoRubro();
    }
