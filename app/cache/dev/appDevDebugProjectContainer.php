...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'glav', 'user' => 'root', 'password' => 'mao182*', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $a->setUsername('umbautomata@gmail.com');
        $a->setPassword('umb2015*');
        $a->setAuthMode(NULL);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'umbautomata@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'umb2015*',
